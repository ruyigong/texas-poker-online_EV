...
class Room:
    ...
    def start_blocked_reason(self) -> str:
        ...
        waiting = [player.name for player in connected if not player.ready_next_hand]
        if waiting:
...
class RoomManager:
    ...
    def can_delete_room(self, room: Room) -> bool:
        return not room.sockets and not any(player.connected for player in room.players.values())
