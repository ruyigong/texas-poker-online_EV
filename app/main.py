    ...
    def public_state(self) -> dict[str, Any]:
        ...
        return {
            ...
            "squid": {
                ...
                "canConfigure": not self.squid_blocks_table_changes(),
