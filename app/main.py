...
class Room:
    ...
    def showdown(self) -> None:
        ...
        self.message = ("; ".join(result_parts) + "." if result_parts else "No chips awarded.") + squid_note + bounty_note
        self.pot = 0
        self.stage = "showdown"
        self.action_deadline = None
        for player in self.seated_players():
