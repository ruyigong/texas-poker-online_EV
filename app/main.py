...
class Room:
    ...
    buy_time_seconds: int = 15
    peek_price_min: int = 10
    peek_price_max: int = 50
    ...
    def live_hand_in_progress(self) -> bool:
        return self.stage in {"straddle", "preflop", "flop", "turn", "river", "reveal", "optional_show"}
        ...
        while True:
            ...
            if action == "start_hand":
                ...
                try:
                    ...
                    buy_time_seconds = int(message.get("buyTimeSeconds", 15))
                    peek_price_min = int(message.get("peekPriceMin", 10))
                    peek_price_max = int(message.get("peekPriceMax", 50))
                except (TypeError, ValueError):
