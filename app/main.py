...
class Room:
    ...
    def start_blocked_reason(self) -> str:
        ...
        if len(seated_with_chips) < 2:
            return "Need at least 2 connected seated players with chips or submitted refill to start."
