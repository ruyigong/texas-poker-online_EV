...
class Room:
    ...
    def buy_time(self, player_id: str) -> str | None:
        ...
        return None
    def configure_blinds(self, small_blind: int, big_blind: int, action_timeout: int | None = None, buy_time_seconds: int | None = None) -> str | None:
        ...
        self.message = f"Blinds set to {small_blind}/{big_blind} {timing}. Clock: {self.action_timeout}s. One buy-time: {self.buy_time_seconds}s."
        return None
        ...
        while True:
            ...
            if action == "start_hand":
                ...
                try:
                    ...
                    buy_time_seconds = 15
                error = room.configure_blinds(small_blind, big_blind, action_timeout, buy_time_seconds)
